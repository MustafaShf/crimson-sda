      ...
      {selectedType ? (
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            <Text style={[styles.cell, styles.headerText, styles.col1]}>Type</Text>
            <Text style={[styles.cell, styles.headerText, styles.col2]}>Can Donate To</Text>
            <Text style={[styles.cell, styles.headerText, styles.col3]}>Can Receive From</Text>
          </View>
          ...
          {data.slice(0, 6).map((row, index) => (
            ...
            >
              <Text style={[styles.cell, styles.typeText, styles.col1]}>{row.type}</Text>
